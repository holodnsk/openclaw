...
export async function runHeartbeatOnce(opts: {
  ...
  // EXCEPTION: Don't skip when there are pending system events (cron reminders,
  // exec completions, etc.) — those must be delivered even without HEARTBEAT.md content.
